...
@section('titulopagina', 'Login de Usuario')
...
@endif
    ...
    <div class="d-flex justify-content-center align-items-center gap-2 mb-3">
        ...
        <div style="background: #212529; border-radius: 8px; padding: 5px; display: flex; align-items: center;">
          <img src="{{ route('usuario.captcha.simple') }}" id="captcha-img" style="border-radius:4px;">
        </div>
        
        <!-- Botón de recarga (Vanilla JS) -->
        <button type="button"
onclick="document.getElementById('captcha-img').src='{{ route('usuario.captcha.simple') }}?'+Math.random()">
↻
</button>
    </div>
