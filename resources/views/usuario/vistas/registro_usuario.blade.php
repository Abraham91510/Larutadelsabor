@extends('usuario.layouts.auth_usuario')
...
<div class="contenedor-auth">
    ...
    <div class="card-auth">
        ...
        {{-- Formulario --}}
        <form method="POST" action="{{ url('/registrar/usuario') }}" enctype="multipart/form-data" id="formRegistro">
            @csrf
    ...
    <select name="tipo_usuario"
        ...
        <div class="link-login mt-4">
            ¿Ya tienes cuenta?
            <a href="{{ url('/login/usuario') }}">Inicia sesión aquí</a>
        </div>
    </div>
</div>
...
<script>
    ...
    form.onsubmit = function(e) {
        ...
        // 🔥 CAMBIO
        const tipo_usuario = document.querySelector('[name="tipo_usuario"]').value;
        ...
        if (
            ...
            alert(
                "No se puede registrar: Todos los campos son obligatorios."
            );
