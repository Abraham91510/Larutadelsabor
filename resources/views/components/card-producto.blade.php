    ...
    <div class="card h-100 border-0 rounded-4 position-relative"
     ...
     style="object-fit: cover">
        ...
        <div class="card-body position-relative">
            ...
            <!-- Nombre del producto -->
            <h6 class="fw-bold mb-1 mt-4 text-center text-truncate" style="max-width: 100%;">
                {{ $titulo }}
            </h6>

            <!-- Categoría y Subcategoría -->
            <small class="text-muted d-flex align-items-center gap-1 mb-1 justify-content-center text-truncate" style="max-width: 100%;">
                <i class="bi bi-tags"></i>
                {{ $categoria }}@if($subcategoria) - {{ $subcategoria }}@endif
            </small>

            <!-- Precio -->
            <div class="text-center fw-bold mb-2">{{ $precio }}</div>
